# Inventory Allocation Simulator — Coding Standards: Live & Integration Testing
...
- Your database (local PostgreSQL, local Redis, local DuckDB) — validates schema, column names, constraints, query behavior
