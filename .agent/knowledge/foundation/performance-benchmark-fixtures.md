...
- `scripts/benchmarks/run_performance_benchmarks.jl` — JSON manifest runner for benchmark fixtures.
...
- Use `performance_targets()` as the source of truth for PRD §10b target values.
