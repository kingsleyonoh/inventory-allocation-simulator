...
export const defaultConfig: RuntimeConfig = {
  ...
  models: {
    ...
    knowledge: { thinking: "high", tools: ["read", "write"], timeoutSeconds: 300 },
    inbox: { thinking: "medium", tools: ["read", "write"], timeoutSeconds: 180 },
    implement: { thinking: "high", tools: ["read", "bash", "edit", "write"], budget: { staleMs: 30 * 60_000, maxToolCalls: 300 } },
    validate: { thinking: "xhigh", tools: ["read", "bash"], budget: { staleMs: 30 * 60_000, maxToolCalls: 300 } },
    journal: { thinking: "medium", tools: ["read", "edit", "write"], budget: { staleMs: 15 * 60_000, maxToolCalls: 120 } },
