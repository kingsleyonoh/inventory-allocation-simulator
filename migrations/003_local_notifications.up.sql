...
CREATE UNIQUE INDEX IF NOT EXISTS local_notifications_tenant_event_idx ON local_notifications (tenant_id, event_id);
...
CREATE INDEX IF NOT EXISTS local_notifications_tenant_source_record_idx ON local_notifications (tenant_id, source_record_type, source_record_id);
